...
const I18N = {
  ...
  reserve_duration_hint:{ th: "สัญญาเช่ารายเดือนขั้นต่ำ 3 เดือน · มัดจำ 1 เดือน (เท่ากับค่าเช่า) · ต้องการรายวันเริ่มต้น 700 บาท/คืน กรุณาโทรหรืออีเมลติดต่อโดยตรง", en: "Minimum monthly contract is 3 months · deposit equals 1 month's rent · for nightly stays from 700 THB/night, please call or email us directly.", zh: "月租合同最短3个月 · 押金为1个月租金 · 如需日租（起价700泰铢/晚），请直接致电或发邮件联系。", ru: "Минимальный срок аренды — 3 месяца · залог равен месячной оплате · для посуточного проживания от 700 бат/ночь звоните или пишите нам напрямую." },
